Game:
	...
	g++ -o Game Game.o Title.o MainGame.o SetEnemyInfo.o Pause.o Audio.o ToolKit.o GameSystem.o UI_Image.o glsl.o Shader.o Controller.o Chara.o Object.o Collider.o RawModel.o Vector.o -lSDL2 -lSDL2_image -lSDL2_mixer -lGL -lglut -lGLU -Wl,-rpath,/usr/local/lib
	rm -f ./*.o
